...
boxplot_bvb_core_sim <- ragweed_flat_aug %>%  
  filter(Group != "Non reactive") %>% 
...
ggsave(filename = "../../results/report/boxplot_bvc_core_sim_ragweed.png", 
       plot = boxplot_bvc_core_sim,
       width = 9, 
       height = 8)

ggsave(filename = "../../results/report/boxplot_bvb_core_sim_ragweed.png", 
       plot = boxplot_bvb_core_sim,
       width = 9, 
       height = 8)

ggsave(filename = "../../results/report/boxplot_rand_core_sim_ragweed.png", 
