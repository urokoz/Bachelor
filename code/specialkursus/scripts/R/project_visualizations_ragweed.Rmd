...
ggsave(filename = "../../results/report/boxplot_bvc_core_sim.png", 
       plot = boxplot_bvc_core_sim,
       width = 9, 
       height = 7)

ggsave(filename = "../../results/report/boxplot_bvb_core_sim.png", 
       plot = boxplot_bvb_core_sim,
       width = 9, 
       height = 7)

ggsave(filename = "../../results/report/boxplot_rand_core_sim.png", 
