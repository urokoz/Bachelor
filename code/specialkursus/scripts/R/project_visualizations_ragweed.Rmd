...
ggsave(filename = "../../results/ragweed_HLA_plot.png", 
...
```{r}
#function: scatter_plot <- function(df, variable1, variable2, si_filter = TRUE, title, xlab, ylab)

scatter_7_allele <- ragweed %>% 
  scatter_plot(best_7_allele_rank, si, si_filter = TRUE, "Stimulation idex as a function of 7 allele rank", "7 alelle rank", "sigmoid(SI)" )
